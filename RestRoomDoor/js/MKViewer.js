...
export class CARviewer {
   ...
   async initScene() {
        ...
        this.camera.position.set(0.1,1.45,-1.5)
        ...
        await LoadModel('RestRoom-door.glb', this.scene) 
        await loadEnvironmentHDR(this.renderer, this.scene, 'env.hdr');
        this.orbit = new OrbitControls(this.camera, this.renderer.domElement);
        this.orbit.minDistance=1.0;
        this.orbit.maxDistance=2.3;
        this.orbit.maxPolarAngle = Math.PI/1.8
        this.orbit.minPolarAngle = Math.PI/2.8
        // this.orbit.minAzimuthAngle = Math.PI*2;
        // this.orbit.maxAzimuthAngle = Math.PI*2;
        this.orbit.target.set(-0.2,1.25,0);
